...
insert into reservation (startdate, enddate, clientid, roomid, price, paid) values ("2017/1/1", "2017/1/2", "AB123456", "101", "40", "0");
insert into reservation (startdate, enddate, clientid, roomid, price, paid) values ("2017/1/3", "2017/1/4", "QW765234", "102", "50", "0");
